...
class RMS:
    def __init__(self, root):
        ...
        # --- Icons ---
        # Note: Ensure 'logo_p.png' and 'bg.png' are inside an 'images' folder
        self.logo_dash = ImageTk.PhotoImage(file=r"D:\student record management system\images\logo_p.png")
        ...
        title = Label(self.root, text="Student Result Management System", 
                      ...
                      padx=10).place(x=0, y=0, relwidth=1, height=50)
        ...
        self.bg_img = Image.open(r"D:\student record management system\images\bg.png")
        ...
        self.lbl_result = Label(self.root, text="Total Results\n[ 0 ]", font=("goudy old style", 20), 
                                bd=10, relief=RIDGE, bg="#038071", fg="white")
