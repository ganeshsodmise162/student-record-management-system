...
class studentClass:
    def __init__(self, root):
        ...
        lbl_state = Entry(self.root, text="State", font=("goudy old style", 15, "bold"), bg="lightyellow").place(x=150, y=220,width=150)
        

        lbl_pin = Label(self.root, text="PIN", font=("goudy old style", 15, "bold"), bg="white").place(x=500, y=220)
        lbl_pin = Entry(self.root, text="PIN", font=("goudy old style", 15, "bold"), bg="lightyellow").place(x=560, y=220,width=90)
        
         
        lbl_city = Label(self.root, text="City", font=("goudy old style", 15, "bold"), bg="white").place(x=310, y=220)
        lbl_city = Entry(self.root, text="City", font=("goudy old style", 15, "bold"), bg="lightyellow").place(x=380, y=220,width=90)
        
        lbl_address = Label(self.root, text="Adress", font=("goudy old style", 15, "bold"), bg="white").place(x=10, y=260)
        ...
        self.txt_gender = ttk.Combobox(self.root, textvariable=self.var_gender,values=("Select","Male","Female","Others"),font=("goudy old style", 15, "bold"),state='readonly')
        self.txt_gender.place(x=150, y=180, width=200)
        self.txt_gender.current(0)

    
        #=========== Entry Fields colunm2 ==============
        ...
        self.txt_course = ttk.Combobox(self.root, textvariable=self.var_course,values=self.course_list,font=("goudy old style", 15, "bold"),state='readonly')
        self.txt_course.place(x=480, y=180, width=200)
        self.txt_ = Entry(self.root, textvariable=self.var_dob, font=("goudy old style", 15, "bold"), bg="lightyellow")
...
#=========Text Add =================================================================================================================================================================
        ...
        self.CourseTable = ttk.Treeview(self.C_Frame, columns=("roll", "name", "email", "gender", "dob","contact","state","admission","course","city","pin","address"), 
...
#==============================================================
    ...
    def delete(self):
        ...
        try:
            if self.var_roll.get() == "":
                ...
                row = cur.fetchone()
                if row == None:
                    messagebox.showerror("Error", "please student from the list first", parent=self.root)
                else:
        ...
        try:
            if self.var_roll.get() == "":
                ...
                if row != None:
                    ...
                    cur.execute(
                    "INSERT INTO student(roll,name,email,gender,dob,contact,state,admission,course,city,pin,address) values(?,?,?,?,?,?,?,?,?,?,?,?)",
                    (
                        self.var_roll.get(),
                        self.var_name.get(),
                        self.var_email.get(),
    ...
    def update(self):
        con = sqlite3.connect("STUDENT_RECORD_MANAGEMENT_SYSTEM.db")
        cur = con.cursor()
        try:
            if self.var_roll.get() == "":
                messagebox.showerror("Error", "Roll No should be required", parent=self.root)
